  ...
  <v-container fluid>
    <v-row v-if="car">
      ...
      <v-col cols="12" md="6" lg="4">
        ...
        <v-row class="mt-0">
          <v-col>
            <v-rating v-model="car.rating" readonly dense length="10" background-color="orange lighten-3"
                      color="orange"/>
          </v-col>
        </v-row>
        <v-row>
          <v-col>
            <v-card class="pa-4">
              <v-row class="pt-3">
                ...
                <v-col cols="12" md="6">
                  <strong>Author</strong><a :href="car.author.link" rel="noopener" target="_blank"> {{car.author.name}}</a>
                  <hr>
                </v-col>
                <v-col cols="12" md="6">
